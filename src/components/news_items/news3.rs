                ...
                <div class={classes!("flex", "gap-3", "text-sm")}>
                    <div class={classes!("flex-1", "flex", "flex-col", "gap-1")}>
                        ...
                        <p class={classes!("mt-2","mb-2")}>
                            <a href="https://pypi.org/project/agentium/" target="_blank">{" PyPI Package [1]"}</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class={classes!("flex-1", "flex", "flex-col", "gap-2")}>
                ...
                <div class={classes!("flex","gap-3","text-sm")}>
                    <div class={classes!("flex-1", "flex", "flex-col", "gap-1")}>
                        ...
                        <p class={classes!("mt-2","mb-2")}>
                            <a href="https://github.com/RNS-Forge/Researcher-Agentic-AI" target="_blank">{" GitHub Repository [2]"}</a>
                        </p>
            ...
            <div class={classes!("flex-1", "flex", "flex-col", "gap-2")}>
                ...
                <div class={classes!("flex", "gap-3", "text-sm")}>
                    <div class={classes!("flex-1", "flex", "flex-col", "gap-1")}>
                        ...
                        <p class={classes!("mt-2","mb-2")}>
                            <a href="https://github.com/RNS-Forge/RNS-Project-Management" target="_blank">{" GitHub Repository [3]"}</a>
                        </p>
                    </div>
                </div>
            </div>
